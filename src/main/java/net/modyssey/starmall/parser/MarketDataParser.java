package net.modyssey.starmall.parser;
...
import net.modyssey.starmall.parser.io.MarketData;
import net.modyssey.starmall.parser.io.StockData;
import net.modyssey.starmall.parser.io.StockDataItem;
